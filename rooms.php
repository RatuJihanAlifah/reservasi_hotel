            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="mb-2">
                  ...
                  <label type="form-check-label" for="f2">Facility Two</label>
                </div>
                <div class="mb-2">
        ...
        <div class="card mb-4 border-0 shadow">
          <div class="row g-0 p-3 align-items-center">
            <div class="col-md-4 mb-lg-0 mb-md-0 mb-3">
              <img src="img/room/deluks.jpg" class="img-fluid rounded" height="250" width="300">
            </div>
            <div class="col-md-5 px-lg-3 px-md-3 px-0">
              <h5 class="mb-3 fw-bold">Deluks Room</h5>
            ...
            <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                <h6 class="mb-4">IDR 1.260.000</h6>
                <a href="#" class="btn w-100 btn-primary btn-sm mb-2">Book Now</a>
                <a href="#" class="btn w-100 btn-outline-primary btn-sm">More Details</a>
            </div>
          </div>
        </div>
        <div class="card mb-4 border-0 shadow">
