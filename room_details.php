        ...
        <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <?php 
              ...
              $room_img = ROOMS_IMG_PATH."deluks_twin.jpg";
              ...
              if(mysqli_num_rows($img_q) > 0) {
                ...
                while($img_res = mysqli_fetch_assoc($img_q)) {
                    echo "<div class='carousel-item $active_class'>
                            <img src='".ROOMS_IMG_PATH.$img_res['image']."' class='d-block w-100 rounded' style='width: 500px; height: 400px; object-fit: cover;'>
                          </div>";
                    $active_class = '';
                }
              }
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            ...
            <h3 class="fw-bold h-font text-center mb-3"><?php echo $room_data['name']?></h3>
