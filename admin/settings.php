          ...
          <div class="card border-0 shadow mb-4">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <button type="button" class="btn btn-outline-primary shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#general-s">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    <input type="text" name="site_title" id="site_title_inp" class="form-control shadow-one" required>
                  </div>
                  <div class="mb-3">
           ...
           <div class="card border-0 shadow mb-4">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <button type="button" class="btn btn-outline-primary shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#contacts-s">
                  <i class="bi bi-pencil-square"></i> Edit
                </button>
              </div>
              <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="text" name="address" id="address_inp" class="form-control shadow-one" required>
                          </div>
                          <div class="mb-3">
                            <label class="form-label fw-bold">Google Map Link</label>
                            <input type="text" name="gmap" id="gmap_inp" class="form-control shadow-one" required>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" name="email" id="email_inp" class="form-control shadow-one" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" name="iframe" id="iframe_inp" class="form-control shadow-one" required>
                          </div>
                        </div>
