function get_bookings(search='') 
{
    ...
    xhr.onload = function() {
        document.getElementById('tabel-data').innerHTML = this.responseText;
    }

    xhr.send('get_bookings&search='+search); // Mengubah pengiriman data sesuai format yang diharapkan di sisi server
}
...
assign_room_form.addEventListener('submit', function(e) {
    ...
    let xhr = new XMLHttpRequest();
    xhr.open("POST", "ajax/new_bookings.php");
